...
//      Ct_L     Opt_L    Cmd_L                               SPACE                               Cmd_R    Opt_R    FN       Left     Down     Right
  ...
  [0] = LAYOUT(
    KC_ESC,  KC_BRID, KC_BRIU, KC_MCTL,    KC_LPAD, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_MRWD, KC_MPLY, KC_MFFD, KC_F12,  KC_DEL,           KC_MUTE,
  ...
  [1] = LAYOUT(
    _______,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,  KC_INS,            RGB_TOG,
...
// clang-format on
  ...
  static void set_rgb_caps_leds(void) {
    ...
    rgb_matrix_set_color(77, 0xFF, 0xFF, 0xFF); // Right side LED 4
    rgb_matrix_set_color(80, 0xFF, 0xFF, 0xFF); // Left side LED 5
